...
- [**remote-juggler**](https://github.com/Jesssullivan/remote-juggler) — Experiment!  Danger!  WIP!  Hide!  Autonomous backend-agnostic identity management for cyborgs *(Chapel · 2 days ago)*
...
- [**minolta-x370-repair**](https://github.com/Jesssullivan/minolta-x370-repair) — x370 wind lever repair, nothing to see here *(TypeScript · 4 days ago)*
...
- [**tummycrypt**](https://github.com/Jesssullivan/tummycrypt) — WIP self-hosted encrypted file sync with on-demand hydration and fleet sync. Odrive/Dropbox-style... *(Rust · 4 ★ · 3 days ago)*
- [**dsa-study-packet**](https://github.com/Jesssullivan/dsa-study-packet) — Company-neutral technical-interview training — Core-42 drills, printable packet, whiteboard perfo... *(Python · 4 days ago)*
- [**rules_tectonic**](https://github.com/Jesssullivan/rules_tectonic) — Bazel rules for compiling LaTeX to PDF with tectonic *(Starlark · 4 days ago)*
...
*Last updated: 2026-07-13 07:21 UTC*
<!--END_SECTION:repos-->
