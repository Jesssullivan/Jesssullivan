...
- [**DarwinNicUtil**](https://github.com/Jesssullivan/DarwinNicUtil) — Extensible utility for dealing with out-of-band management / air gapped network devices, mostly f... *(Python · 2 ★ · today)*
...
- [**scheduling-kit**](https://github.com/tinyland-inc/scheduling-kit) — Backend-agnostic scheduling system with Acuity, CalCom, and homegrown adapters *(TypeScript · 1 ★ · 2 days ago)*
...
*Last updated: 2026-09-10 06:33 UTC*
<!--END_SECTION:repos-->

<!--START_SECTION:foss-->
<details>
<summary><strong>FOSS Contributions</strong> (22)</summary>
