...
- [**tinyland-cleanup**](https://github.com/Jesssullivan/tinyland-cleanup) — Cross-platform disk cleanup daemon with graduated thresholds — Go, Nix, systemd/launchd *(Go · 1 ★ · 2 days ago)*
...
- [**Dell-7810**](https://github.com/Jesssullivan/Dell-7810) — Notes, instrumentation, configuration and monkey jabber on taking Dell 7810 servers way, way too far *(Shell · 1 ★ · 3 weeks ago)*
...
- [**tinyland-goo**](https://github.com/Jesssullivan/tinyland-goo) — UV-reactive strontium-aluminate 3D-printer bed glue: recipe, weight scaler, UV coverage-sensing B... *(Svelte · 2 weeks ago)*
...
- [**magiclantern_hydrogen**](https://github.com/Jesssullivan/magiclantern_hydrogen) — ML derivation for Jess's specific stuff: software-defined filter hacking for heavily modified 1d ... *(C · 4 weeks ago)*
...
- [**transfemme-tailoring**](https://github.com/Jesssullivan/transfemme-tailoring) — Build log + interactive alteration calculators for refitting masculine-cut formalwear into a tran... *(Svelte · 3 days ago)*
- [**dsa-woodshed.space**](https://github.com/Jesssullivan/dsa-woodshed.space) — Editor-first technical interview practice in Codespaces: ordinary reasoning comments, candidate-o... *(TypeScript · 6 days ago)*
...
- [**tummycrypt**](https://github.com/Jesssullivan/tummycrypt) — WIP.   *(Rust · 4 ★ · 2 days ago)*
...
- [**dsa-study-packet**](https://github.com/Jesssullivan/dsa-study-packet) — Company-neutral technical interview practice in a real editor: reason in comments, implement, wri... *(Python · 1 week ago)*
...
- [**rules_tectonic**](https://github.com/Jesssullivan/rules_tectonic) — Bazel rules for compiling LaTeX to PDF with tectonic *(Starlark · 3 weeks ago)*
...
- [**moonlight**](https://github.com/tinyland-inc/moonlight) — Tinyland fork of moonlight-stream/moonlight-qt (certificate-only pairing mode; Rocky RPM + signed... *(C++ · 1 week ago)*
- [**sunshine**](https://github.com/tinyland-inc/sunshine) — Tinyland fork of LizardByte/Sunshine (CertOnlyAuth mesh pairing; Rocky RPM + notarized macOS buil... *(C++ · 1 week ago)*
...
- [**scheduling-bridge.tinyland.dev**](https://github.com/tinyland-inc/scheduling-bridge.tinyland.dev) — Brand site for scheduling-bridge — monadic booking middleware for hostile calendar stacks (brand ... *(Svelte · 4 days ago)*
...
- [**ci-templates**](https://github.com/tinyland-inc/ci-templates) — Reusable GitHub Actions composite actions for Nix, Attic cache, and CI/CD *(Ruby · today)*
