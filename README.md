...
- [**futhark-bessel**](https://github.com/Jesssullivan/futhark-bessel) — Provenance-clean J0, J1, and positive J1 roots for Futhark *(Python · 2 weeks ago)*
...
- [**tailnet-acl**](https://github.com/Jesssullivan/tailnet-acl) — Dhall-typed Tailscale ACL policy & simple CD infrastructure *(Python · 1 ★ · 5 days ago)*
...
- [**XoxdWM**](https://github.com/Jesssullivan/XoxdWM) — Eye-gesture VR & BCI XWayland Emacs Window Manager for transhumans and cyborgs *(Emacs Lisp · 2 ★ · 3 days ago)*
...
- [**scheduling-kit**](https://github.com/tinyland-inc/scheduling-kit) — Backend-agnostic scheduling system with Acuity, CalCom, and homegrown adapters *(TypeScript · 1 ★ · 4 days ago)*
...
- [**prompt-pulse-go-archive**](https://github.com/tinyland-inc/prompt-pulse-go-archive) — ARCHIVED: retired Go static shell dashboard; Lab delivery removed by TIN-3350. Historical code on... *(Go · 4 weeks ago)*
